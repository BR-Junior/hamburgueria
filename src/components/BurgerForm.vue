        ...
        <div>
            <form id="burger-form" @submit="createBurger">
                ...
                <div class="input-container">
                    ...
                    <select name="pao" id="pao" v-model="pao" @click="getIngredientes">
                ...
                <div class="input-container">
                    ...
                    <select name="carne" id="carne" v-model="carne" @click="getIngredientes">
                ...
                <div id="opcionais-title" class="input-container">
                    ...
                    <div class="checkbox-container" v-for="opcional in opcionaisdata" :key="opcional.id" :value="opcional.id">
...
import { ref } from 'vue';
import Message from '../components/Massage.vue'
